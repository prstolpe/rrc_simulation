...
def Critic_gen(state_size, action_size, hidden_layers):
    ...
    x = Dense(hidden_layers[-1], kernel_initializer=tf.random_uniform_initializer(minval=-0.003, maxval=0.003))(x)
...
def Actor_gen(state_size, action_size, hidden_layers, action_mult=1):
    ...
    x = Dense(action_size, activation='tanh', kernel_initializer=tf.random_uniform_initializer(minval=-0.003, maxval=0.003))(x)
